...
// SuperTokensConfig is the configuration for SuperTokens core with ThirdPartyEmailPassword recipe
var SuperTokensConfig = supertokens.TypeInput{
    ...
    RecipeList: []supertokens.Recipe{
        thirdpartyemailpassword.Init(&tpepmodels.TypeInput{
            Providers: []tpepmodels.ProviderInput{
                {
                    Config: tpepmodels.ProviderConfig{
                        ThirdPartyId: "google",
                        Clients: []tpepmodels.ProviderClientConfig{
                            {
