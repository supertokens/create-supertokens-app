...
const socialLogin = async (thirdPartyId: string): Promise<SocialLoginResponse> => {
    try {
...
const callbackHandler = async (): Promise<CallBackResponse> => {
    try {
...
export { socialLogin, callbackHandler };
