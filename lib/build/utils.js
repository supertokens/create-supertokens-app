...
async function setupFrontendBackendApp(answers, folderName, locations) {
    ...
    fs.copyFileSync(`${folderName}/frontend/${normaliseLocationPath(selectedFrontend.location.configFiles)}/${recipeConfig[0]}`, `${folderName}/frontend/${normaliseLocationPath(selectedFrontend.location.finalConfig)}`);
