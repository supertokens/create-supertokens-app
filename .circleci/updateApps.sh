...
rm -rf emailpassword
npx -y create-supertokens-app@latest --frontend=next-app-dir --recipe=emailpassword --appname=emailpassword
cd emailpassword
...
npx -y create-supertokens-app@latest --frontend=next-app-dir --recipe=thirdpartyemailpassword --appname=thirdpartyemailpassword
